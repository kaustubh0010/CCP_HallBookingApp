package com.example.hallbooking.admin;
...
import com.example.hallbooking.database.bookedDetailsDBHandler;
import com.example.hallbooking.database.userDBHandler;
...
public class adminPage extends AppCompatActivity {
    ...
    CardView cardAddVenue, cardBookedVenues, cardViewAllVenues, cardViewAllUsers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardBookedVenues = findViewById(R.id.cardBookedVenues);
        cardViewAllVenues = findViewById(R.id.cardViewAllVenues);
...
//         goto different pages
        cardAddVenue.setOnClickListener(v -> {
            Intent intent = new Intent(adminPage.this, addVenue.class); // Replace with your actual activity
            startActivity(intent);
        });

        cardBookedVenues.setOnClickListener(v -> {
            Intent intent = new Intent(adminPage.this, booked_venues.class);
            startActivity(intent);
        });

        cardViewAllVenues.setOnClickListener(v -> {
            Intent intent = new Intent(adminPage.this, viewAllVenues.class);
            startActivity(intent);
        });

        cardViewAllUsers.setOnClickListener(v -> {
            Intent intent = new Intent(adminPage.this, viewAllUsers.class);
            startActivity(intent);
        });
    }
