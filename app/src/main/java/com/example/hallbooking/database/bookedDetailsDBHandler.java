package com.example.hallbooking.database;
...
import com.example.hallbooking.Utils.notificationHelper;
import com.example.hallbooking.homePage;
import com.example.hallbooking.receivers.StatusUpdateWorker;
...
public class bookedDetailsDBHandler extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "CCPdb";
